/**
 * Botão "+ Adicionar empresa" com modal.
 */
        ...
        <div className="apb-modal" onClick={(e) => e.stopPropagation()}>
          ...
          <form action={formAction} className="apb-form">
            <label className="apb-label">
              Nome da empresa *
              <input name="name" required maxLength={200} autoFocus className="apb-input" placeholder="ex: Nubank" />
            </label>
            <div className="apb-row">
              <label className="apb-label">
                Indústria
                <input name="industry" maxLength={120} className="apb-input" placeholder="ex: Fintech" />
              </label>
              <label className="apb-label">
                Porte
                <input name="size" maxLength={60} className="apb-input" placeholder="ex: 51-200" />
              </label>
            </div>
            <label className="apb-label">
              Website
              <input name="website" type="url" className="apb-input" placeholder="https://nubank.com.br" />
            </label>
            <label className="apb-label">
              LinkedIn URL
