...
const ICON_MAP: Record<string, LucideIcon> = {
  ...
  Palette,
  Library,
  // 3ª curadoria mai/2026: troca de Trophy por Coins na Dica 02 (gamificação,
  // remete à moeda do app de pontos da plataforma Boldfy).
  Coins,
};
  ...
  return (
    <section className="py-16 sm:py-24">
      <div className="mx-auto max-w-[1080px] px-6">
        <SectionTag>Dicas + Boldfy</SectionTag>
        <h2 className="mb-3 font-headline text-3xl font-black tracking-tight text-foreground sm:text-4xl">
          ...
          <span className="bg-gradient-to-br from-[#CD50F1] to-[#E875FF] bg-clip-text text-transparent">
            especialmente desenhadas pro seu caso
          </span>
        </h2>
        <p className="mb-10 max-w-[720px] text-base leading-relaxed text-muted-foreground">
          Cada dica abre como a Boldfy resolve embaixo.
        </p>
...
function DicaCard({ tip, slug }: { tip: Tip; slug: string }) {
  ...
  // Padrão único pra todas as outras: card com ícone, número, título,
  // mini-descrição e accordion "Veja como a Boldfy resolve" (fechado por
  // padrão). Vale pras universais e pras condicionais (3ª curadoria mai/2026
  // tirou a variante "imperativa" com borda lateral roxa pra manter padrão
  // visual único).
  ...
  return (
    ...
    >
      ...
      {/* Mini-descrição (mai/2026 3ª curadoria): contexto curto pra pessoa
        ...
        */}
        ...
        >
          <span className="flex items-center gap-1.5">
            <FaiAvatar size={16} className="ring-1 ring-primary/20" />
