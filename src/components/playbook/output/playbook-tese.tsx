    ...
    <section className="bg-secondary/30 py-16 sm:py-24">
      <div className="mx-auto max-w-[1080px] px-6">
        ...
        {/* Bloco 3.5 — Setor aplicação (logo abaixo dos cards da tese,
            ...
            Nota jun/2026: tentamos conexões SVG animadas entre cada card
            de Tese e o mini-card de Motivo correspondente no Bloco 3.5,
            mas o alinhamento via coordenadas fixas + preserveAspectRatio
            ficou frustro (linhas saíam do meio do bloco em vez dos cards).
            Pra fazer direito precisaria de refs + medição em runtime —
            esforço alto pra ganho visual baixo (os números 01/02/03 dos
            dois lados já implicam a correspondência). Decidimos remover. */}
