...
export function VendasClient() {
  ...
  return (
    <>
      ...
      {/* ============================================================ */}
      <section className="relative overflow-hidden bg-background px-6 py-24 md:px-12">
        <Glow className="bottom-0 left-[-100px] h-[600px] w-[600px] opacity-[0.08]" />
        ...
        <div className="relative z-10 mx-auto max-w-[1200px]">
          ...
          <div className="relative grid grid-cols-1 gap-[18px] sm:grid-cols-2 lg:grid-cols-4">
            ...
            <div className="pointer-events-none absolute left-[60px] right-[60px] top-[28px] hidden h-[2px] bg-gradient-to-r from-transparent via-amber-500/35 to-transparent lg:block" />
            ...
            {[
              ...
              <div
                key={marco.month}
                className="relative z-[1] rounded-2xl border border-border bg-card p-5 transition-all duration-300 hover:-translate-y-1 hover:border-amber-500/35 hover:shadow-[0_16px_40px_rgba(245,158,11,0.14)]"
              >
                <span className="mb-3.5 inline-flex items-center gap-1.5 rounded-lg bg-amber-500 px-3 py-[7px] font-headline text-xs font-black text-white shadow-[0_4px_12px_rgba(245,158,11,0.35)]">
                  {marco.month}
                </span>
      ...
      {/* ============================================================ */}
      {/*  S7 — CAMINHOS (só 1 card pra Vendas)                         */}
      {/* ============================================================ */}
      <section className="relative overflow-hidden bg-background px-6 py-24 md:px-12">
        <Glow
