...
function parseParams(sp: Record<string, string | string[] | undefined>): Params {
  ...
  const validFormTypes: Array<Params['formType']> = ['all', 'form_submit_demo', 'form_submit_beta', 'form_submit_algoritmo_linkedin', 'form_submit_case_semrush', 'form_submit_proposta', 'form_submit_playbook_team_led_growth', 'form_submit_eventosbh', 'unsubscribed'];
  return {
...
async function getPeopleWithForms(params: Params): Promise<{
  ...
  const countsByForm: Record<FormType, number> = {
    form_submit_demo: 0, form_submit_beta: 0, form_submit_algoritmo_linkedin: 0, form_submit_case_semrush: 0, form_submit_proposta: 0, form_submit_playbook_team_led_growth: 0, form_submit_eventosbh: 0,
  };
